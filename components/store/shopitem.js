...
const ShopItem = connect(mapStateToProps, mapDispatchToProps)(PShopItem);
...
function PShopItem(props) {
	return (
		<li
			onClick={
				props.money >=
				props.itemInformation.cost * (props.itemInformation.own + 1)
					? props.buyItem
					: props.cantBuyItem
			}
		>
			<div className="shop-item-icon">
				...
				{props.access && (
					<img
						src={require("../../images/" + props.access + ".svg")}
						alt="rat"
					/>
				)}
			</div>
			<div className="shop-item-info">
				...
				{props.access !== "click" ? (
					<Fragment>
						...
						<p>
							Gain:{" "}
							{props.itemInformation.gain *
								(props.itemInformation.own > 0
									? props.itemInformation.own
									: 1) *
								props.itemInformation.multiplier}
						</p>
					</Fragment>
				) : (
					<p>
				...
				<p>
					Cost:{" "}
					{props.itemInformation.cost *
						(props.itemInformation.own + 1)}
				</p>
